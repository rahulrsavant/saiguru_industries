...
public class FormulaRegistry {
    private final Map<String, Formula> formulas = Map.ofEntries(
        ...
        Map.entry("ANGLE_EQUAL", new AngleEqualFormula()),
        Map.entry("ANGLE_UNEQUAL", new AngleUnequalFormula()),
        Map.entry("CHANNEL_C", new ChannelFormula()),
        Map.entry("CHANNEL_U", new ChannelFormula()),
        Map.entry("BEAM_I", new BeamIFormula()),
        Map.entry("BEAM_T", new BeamTFormula()),
